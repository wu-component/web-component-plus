...
export interface AddEventListener {
  (elm: Element | Document | Window, eventName: string, cb: EventListenerCallback, opts?: any): Function;
}
...
export interface Hyperscript {
  ...
  // (sel: any, data: VNodeData, children: VNode): VNode;export
}
...
export interface CompilerWorkerContext {
  ...
  ): Promise<{ output: string; diagnostics: any[]; sourceMap?: SourceMap }>;
