...
export default class WuIconRefreshLeft extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-refresh-left')) {
    customElements.define('wu-icon-refresh-left', WuIconRefreshLeft);
}
