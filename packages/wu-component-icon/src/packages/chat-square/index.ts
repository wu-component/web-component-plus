...
export default class WuIconChatSquare extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-chat-square')) {
    customElements.define('wu-icon-chat-square',  WuIconChatSquare);
}
