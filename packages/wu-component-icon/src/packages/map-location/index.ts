...
export default class WuIconMapLocation extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-map-location')) {
    customElements.define('wu-icon-map-location',  WuIconMapLocation);
}
