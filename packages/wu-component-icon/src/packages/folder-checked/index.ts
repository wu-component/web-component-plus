...
export default class WuIconFolderChecked extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-folder-checked')) {
    customElements.define('wu-icon-folder-checked',  WuIconFolderChecked);
}
