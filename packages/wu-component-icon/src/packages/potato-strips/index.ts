...
export default class WuIconPotatoStrips extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-potato-strips')) {
    customElements.define('wu-icon-potato-strips', WuIconPotatoStrips);
}
