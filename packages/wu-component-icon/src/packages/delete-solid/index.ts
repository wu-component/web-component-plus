...
export default class WuIconDeleteSolid extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-delete-solid')) {
    customElements.define('wu-icon-delete-solid', WuIconDeleteSolid);
}
