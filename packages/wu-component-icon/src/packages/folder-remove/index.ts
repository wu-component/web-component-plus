...
export default class WuIconFolderRemove extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-folder-remove')) {
    customElements.define('wu-icon-folder-remove', WuIconFolderRemove);
}
