...
export default class WuIconKnifeFork extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-knife-fork')) {
    customElements.define('wu-icon-knife-fork',  WuIconKnifeFork);
}
