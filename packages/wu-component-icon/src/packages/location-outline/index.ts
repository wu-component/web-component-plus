...
export default class WuIconLocationOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-location-outline')) {
    customElements.define('wu-icon-location-outline',  WuIconLocationOutline);
}
