...
export default class WuIconCScaleToOriginal extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-c-scale-to-original')) {
    customElements.define('wu-icon-c-scale-to-original', WuIconCScaleToOriginal);
}
