...
export default class WuIconArrowDown extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-arrow-down')) {
    customElements.define('wu-icon-arrow-down', WuIconArrowDown);
}
