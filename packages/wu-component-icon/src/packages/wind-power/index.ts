...
export default class WuIconWindPower extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-wind-power')) {
    customElements.define('wu-icon-wind-power',  WuIconWindPower);
}
