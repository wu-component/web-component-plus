...
export default class WuIconRefrigerator extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-refrigerator')) {
    customElements.define('wu-icon-refrigerator',  WuIconRefrigerator);
}
