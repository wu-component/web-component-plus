...
export default class WuIconChatLineRound extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-chat-line-round')) {
    customElements.define('wu-icon-chat-line-round', WuIconChatLineRound);
}
