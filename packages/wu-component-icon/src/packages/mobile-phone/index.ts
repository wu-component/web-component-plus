...
export default class WuIconMobilePhone extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-mobile-phone')) {
    customElements.define('wu-icon-mobile-phone', WuIconMobilePhone);
}
