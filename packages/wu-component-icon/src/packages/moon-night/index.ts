...
export default class WuIconMoonNight extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-moon-night')) {
    customElements.define('wu-icon-moon-night',  WuIconMoonNight);
}
