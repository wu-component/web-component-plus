...
export default class WuIconArrowLeft extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-arrow-left')) {
    customElements.define('wu-icon-arrow-left', WuIconArrowLeft);
}
