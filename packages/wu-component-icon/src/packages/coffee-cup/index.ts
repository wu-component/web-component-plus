...
export default class WuIconCoffeeCup extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-coffee-cup')) {
    customElements.define('wu-icon-coffee-cup',  WuIconCoffeeCup);
}
