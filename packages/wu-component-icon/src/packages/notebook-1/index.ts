...
export default class WuIconNotebook1 extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-notebook-1')) {
    customElements.define('wu-icon-notebook-1',  WuIconNotebook1);
}
