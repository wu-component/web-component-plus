...
export default class WuIconBottomLeft extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-bottom-left')) {
    customElements.define('wu-icon-bottom-left',  WuIconBottomLeft);
}
