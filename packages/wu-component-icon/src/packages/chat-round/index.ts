...
export default class WuIconChatRound extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-chat-round')) {
    customElements.define('wu-icon-chat-round', WuIconChatRound);
}
