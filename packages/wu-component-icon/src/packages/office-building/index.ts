...
export default class WuIconOfficeBuilding extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-office-building')) {
    customElements.define('wu-icon-office-building',  WuIconOfficeBuilding);
}
