...
export default class WuIconToiletPaper extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-toilet-paper')) {
    customElements.define('wu-icon-toilet-paper',  WuIconToiletPaper);
}
