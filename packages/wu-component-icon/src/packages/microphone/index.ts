...
export default class WuIconMicrophone extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-microphone')) {
    customElements.define('wu-icon-microphone', WuIconMicrophone);
}
