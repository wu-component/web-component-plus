...
export default class WuIconCaretRight extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-caret-right')) {
    customElements.define('wu-icon-caret-right', WuIconCaretRight);
}
