...
export default class WuIconWarningOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-warning-outline')) {
    customElements.define('wu-icon-warning-outline',  WuIconWarningOutline);
}
