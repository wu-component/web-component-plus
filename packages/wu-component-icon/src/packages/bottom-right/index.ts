...
export default class WuIconBottomRight extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-bottom-right')) {
    customElements.define('wu-icon-bottom-right',  WuIconBottomRight);
}
