...
export default class WuIconVideoPlay extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-video-play')) {
    customElements.define('wu-icon-video-play', WuIconVideoPlay);
}
