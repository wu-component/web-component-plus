...
export default class WuIconChatDotSquare extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-chat-dot-square')) {
    customElements.define('wu-icon-chat-dot-square', WuIconChatDotSquare);
}
