...
export default class WuIconCircleCheck extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-circle-check')) {
    customElements.define('wu-icon-circle-check', WuIconCircleCheck);
}
