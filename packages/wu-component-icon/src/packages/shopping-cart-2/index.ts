...
export default class WuIconShoppingCart2 extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-shopping-cart-2')) {
    customElements.define('wu-icon-shopping-cart-2',  WuIconShoppingCart2);
}
