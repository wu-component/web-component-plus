...
export default class WuIconNoSmoking extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-no-smoking')) {
    customElements.define('wu-icon-no-smoking',  WuIconNoSmoking);
}
