...
export default class WuIconVideoCameraSolid extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-video-camera-solid')) {
    customElements.define('wu-icon-video-camera-solid', WuIconVideoCameraSolid);
}
