...
export default class WuIconBasketball extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-basketball')) {
    customElements.define('wu-icon-basketball',  WuIconBasketball);
}
