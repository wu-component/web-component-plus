...
export default class WuIconFirstAidKit extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-first-aid-kit')) {
    customElements.define('wu-icon-first-aid-kit', WuIconFirstAidKit);
}
