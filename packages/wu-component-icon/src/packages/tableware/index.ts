...
export default class WuIconTableware extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-tableware')) {
    customElements.define('wu-icon-tableware',  WuIconTableware);
}
