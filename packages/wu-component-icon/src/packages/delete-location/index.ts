...
export default class WuIconDeleteLocation extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-delete-location')) {
    customElements.define('wu-icon-delete-location', WuIconDeleteLocation);
}
