...
export default class WuIconFolderAdd extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-folder-add')) {
    customElements.define('wu-icon-folder-add', WuIconFolderAdd);
}
