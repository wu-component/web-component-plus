...
export default class WuIconMagicStick extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-magic-stick')) {
    customElements.define('wu-icon-magic-stick',  WuIconMagicStick);
}
