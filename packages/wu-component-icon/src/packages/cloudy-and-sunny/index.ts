...
export default class WuIconCloudyAndSunny extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-cloudy-and-sunny')) {
    customElements.define('wu-icon-cloudy-and-sunny',  WuIconCloudyAndSunny);
}
