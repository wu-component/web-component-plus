...
export default class WuIconSManagement extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-s-management')) {
    customElements.define('wu-icon-s-management', WuIconSManagement);
}
