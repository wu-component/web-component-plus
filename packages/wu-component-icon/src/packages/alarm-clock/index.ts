...
export default class WuIconAlarmClock extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-alarm-clock')) {
    customElements.define('wu-icon-alarm-clock',  WuIconAlarmClock);
}
