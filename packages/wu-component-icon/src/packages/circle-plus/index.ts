...
export default class WuIconCirclePlus extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-circle-plus')) {
    customElements.define('wu-icon-circle-plus', WuIconCirclePlus);
}
