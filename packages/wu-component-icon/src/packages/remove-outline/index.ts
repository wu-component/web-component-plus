...
export default class WuIconRemoveOutline extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-remove-outline')) {
    customElements.define('wu-icon-remove-outline', WuIconRemoveOutline);
}
