...
export default class WuIconRefreshRight extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-refresh-right')) {
    customElements.define('wu-icon-refresh-right',  WuIconRefreshRight);
}
