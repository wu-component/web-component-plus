...
export default class WuIconDArrowLeft extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-d-arrow-left')) {
    customElements.define('wu-icon-d-arrow-left', WuIconDArrowLeft);
}
