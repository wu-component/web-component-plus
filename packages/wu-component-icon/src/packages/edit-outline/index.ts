...
export default class WuIconEditOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-edit-outline')) {
    customElements.define('wu-icon-edit-outline',  WuIconEditOutline);
}
