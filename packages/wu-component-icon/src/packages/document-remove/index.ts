...
export default class WuIconDocumentRemove extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-document-remove')) {
    customElements.define('wu-icon-document-remove', WuIconDocumentRemove);
}
