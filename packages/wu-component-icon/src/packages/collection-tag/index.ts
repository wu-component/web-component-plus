...
export default class WuIconCollectionTag extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-collection-tag')) {
    customElements.define('wu-icon-collection-tag',  WuIconCollectionTag);
}
