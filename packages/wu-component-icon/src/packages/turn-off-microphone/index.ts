...
export default class WuIconTurnOffMicrophone extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-turn-off-microphone')) {
    customElements.define('wu-icon-turn-off-microphone', WuIconTurnOffMicrophone);
}
