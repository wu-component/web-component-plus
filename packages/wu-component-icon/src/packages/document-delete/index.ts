...
export default class WuIconDocumentDelete extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-document-delete')) {
    customElements.define('wu-icon-document-delete', WuIconDocumentDelete);
}
