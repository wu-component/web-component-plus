...
export default class WuIconNotebook2 extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-notebook-2')) {
    customElements.define('wu-icon-notebook-2', WuIconNotebook2);
}
