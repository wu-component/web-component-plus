...
export default class WuIconColdDrink extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-cold-drink')) {
    customElements.define('wu-icon-cold-drink',  WuIconColdDrink);
}
