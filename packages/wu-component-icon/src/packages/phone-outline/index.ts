...
export default class WuIconPhoneOutline extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-phone-outline')) {
    customElements.define('wu-icon-phone-outline', WuIconPhoneOutline);
}
