...
export default class WuIconArrowRight extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-arrow-right')) {
    customElements.define('wu-icon-arrow-right',  WuIconArrowRight);
}
