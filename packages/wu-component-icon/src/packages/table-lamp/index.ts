...
export default class WuIconTableLamp extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-table-lamp')) {
    customElements.define('wu-icon-table-lamp',  WuIconTableLamp);
}
