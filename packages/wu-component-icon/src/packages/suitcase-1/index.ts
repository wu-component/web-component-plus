...
export default class WuIconSuitcase1 extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-suitcase-1')) {
    customElements.define('wu-icon-suitcase-1', WuIconSuitcase1);
}
