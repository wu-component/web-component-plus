...
export default class WuIconSPromotion extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-s-promotion')) {
    customElements.define('wu-icon-s-promotion', WuIconSPromotion);
}
