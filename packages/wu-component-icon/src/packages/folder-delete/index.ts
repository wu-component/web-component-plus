...
export default class WuIconFolderDelete extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-folder-delete')) {
    customElements.define('wu-icon-folder-delete', WuIconFolderDelete);
}
