...
export default class WuIconChatLineSquare extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-chat-line-square')) {
    customElements.define('wu-icon-chat-line-square',  WuIconChatLineSquare);
}
