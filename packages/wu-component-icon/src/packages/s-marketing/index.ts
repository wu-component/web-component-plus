...
export default class WuIconSMarketing extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-s-marketing')) {
    customElements.define('wu-icon-s-marketing', WuIconSMarketing);
}
