...
export default class WuIconShoppingCart1 extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-shopping-cart-1')) {
    customElements.define('wu-icon-shopping-cart-1',  WuIconShoppingCart1);
}
