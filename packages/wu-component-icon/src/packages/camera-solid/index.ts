...
export default class WuIconCameraSolid extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-camera-solid')) {
    customElements.define('wu-icon-camera-solid',  WuIconCameraSolid);
}
