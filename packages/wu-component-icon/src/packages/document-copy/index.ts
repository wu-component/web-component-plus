...
export default class WuIconDocumentCopy extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-document-copy')) {
    customElements.define('wu-icon-document-copy', WuIconDocumentCopy);
}
