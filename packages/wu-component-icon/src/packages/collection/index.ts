...
export default class WuIconCollection extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-collection')) {
    customElements.define('wu-icon-collection',  WuIconCollection);
}
