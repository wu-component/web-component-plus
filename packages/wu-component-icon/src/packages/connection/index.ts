...
export default class WuIconConnection extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-connection')) {
    customElements.define('wu-icon-connection',  WuIconConnection);
}
