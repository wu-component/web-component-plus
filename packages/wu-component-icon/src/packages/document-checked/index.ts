...
export default class WuIconDocumentChecked extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-document-checked')) {
    customElements.define('wu-icon-document-checked',  WuIconDocumentChecked);
}
