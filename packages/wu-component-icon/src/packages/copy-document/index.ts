...
export default class WuIconCopyDocument extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-copy-document')) {
    customElements.define('wu-icon-copy-document',  WuIconCopyDocument);
}
