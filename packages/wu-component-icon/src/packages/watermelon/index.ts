...
export default class WuIconWatermelon extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-watermelon')) {
    customElements.define('wu-icon-watermelon',  WuIconWatermelon);
}
