...
export default class WuIconCircleClose extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-circle-close')) {
    customElements.define('wu-icon-circle-close', WuIconCircleClose);
}
