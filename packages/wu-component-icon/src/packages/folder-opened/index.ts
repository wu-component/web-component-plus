...
export default class WuIconFolderOpened extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-folder-opened')) {
    customElements.define('wu-icon-folder-opened', WuIconFolderOpened);
}
