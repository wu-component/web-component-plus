...
export default class WuIconCirclePlusOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-circle-plus-outline')) {
    customElements.define('wu-icon-circle-plus-outline',  WuIconCirclePlusOutline);
}
