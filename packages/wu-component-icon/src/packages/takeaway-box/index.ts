...
export default class WuIconTakeawayBox extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-takeaway-box')) {
    customElements.define('wu-icon-takeaway-box',  WuIconTakeawayBox);
}
