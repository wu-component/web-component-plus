...
export default class WuIconHeavyRain extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-heavy-rain')) {
    customElements.define('wu-icon-heavy-rain',  WuIconHeavyRain);
}
