...
export default class WuIconPictureOutlineRound extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-picture-outline-round')) {
    customElements.define('wu-icon-picture-outline-round',  WuIconPictureOutlineRound);
}
