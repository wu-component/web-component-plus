...
export default class WuIconPartlyCloudy extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-partly-cloudy')) {
    customElements.define('wu-icon-partly-cloudy',  WuIconPartlyCloudy);
}
