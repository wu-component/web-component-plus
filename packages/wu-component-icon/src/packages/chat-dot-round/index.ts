...
export default class WuIconChatDotRound extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-chat-dot-round')) {
    customElements.define('wu-icon-chat-dot-round', WuIconChatDotRound);
}
