...
export default class WuIconDocumentAdd extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-document-add')) {
    customElements.define('wu-icon-document-add', WuIconDocumentAdd);
}
