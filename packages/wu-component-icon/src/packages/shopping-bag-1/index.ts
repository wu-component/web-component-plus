...
export default class WuIconShoppingBag1 extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-shopping-bag-1')) {
    customElements.define('wu-icon-shopping-bag-1',  WuIconShoppingBag1);
}
