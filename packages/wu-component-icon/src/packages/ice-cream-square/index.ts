...
export default class WuIconIceCreamSquare extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-ice-cream-square')) {
    customElements.define('wu-icon-ice-cream-square',  WuIconIceCreamSquare);
}
