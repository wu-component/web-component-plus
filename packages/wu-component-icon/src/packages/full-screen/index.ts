...
export default class WuIconFullScreen extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-full-screen')) {
    customElements.define('wu-icon-full-screen',  WuIconFullScreen);
}
