...
export default class WuIconGobletSquare extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-goblet-square')) {
    customElements.define('wu-icon-goblet-square', WuIconGobletSquare);
}
