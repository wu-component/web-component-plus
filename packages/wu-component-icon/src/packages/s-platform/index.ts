...
export default class WuIconSPlatform extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-s-platform')) {
    customElements.define('wu-icon-s-platform', WuIconSPlatform);
}
