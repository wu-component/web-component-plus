...
export default class WuIconGobletFull extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-goblet-full')) {
    customElements.define('wu-icon-goblet-full', WuIconGobletFull);
}
