...
export default class WuIconCloseNotification extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-close-notification')) {
    customElements.define('wu-icon-close-notification',  WuIconCloseNotification);
}
