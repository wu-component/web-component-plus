...
export default class WuIconPictureOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-picture-outline')) {
    customElements.define('wu-icon-picture-outline',  WuIconPictureOutline);
}
