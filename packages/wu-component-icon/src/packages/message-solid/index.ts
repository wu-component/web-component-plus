...
export default class WuIconMessageSolid extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-message-solid')) {
    customElements.define('wu-icon-message-solid', WuIconMessageSolid);
}
