...
export default class WuIconDataAnalysis extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-data-analysis')) {
    customElements.define('wu-icon-data-analysis',  WuIconDataAnalysis);
}
