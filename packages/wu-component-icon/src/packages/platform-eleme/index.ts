...
export default class WuIconPlatformEleme extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-platform-eleme')) {
    customElements.define('wu-icon-platform-eleme',  WuIconPlatformEleme);
}
