...
export default class WuIconCaretBottom extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-caret-bottom')) {
    customElements.define('wu-icon-caret-bottom', WuIconCaretBottom);
}
