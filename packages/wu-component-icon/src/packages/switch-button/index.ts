...
export default class WuIconSwitchButton extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-switch-button')) {
    customElements.define('wu-icon-switch-button', WuIconSwitchButton);
}
