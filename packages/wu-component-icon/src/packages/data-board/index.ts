...
export default class WuIconDataBoard extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-data-board')) {
    customElements.define('wu-icon-data-board', WuIconDataBoard);
}
