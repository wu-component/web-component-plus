...
export default class WuIconForkSpoon extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-fork-spoon')) {
    customElements.define('wu-icon-fork-spoon',  WuIconForkSpoon);
}
