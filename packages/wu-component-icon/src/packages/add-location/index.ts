...
export default class WuIconAddLocation extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-add-location')) {
    customElements.define('wu-icon-add-location',  WuIconAddLocation);
}
