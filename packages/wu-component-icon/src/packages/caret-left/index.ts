...
export default class WuIconCaretLeft extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-caret-left')) {
    customElements.define('wu-icon-caret-left',  WuIconCaretLeft);
}
