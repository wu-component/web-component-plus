...
export default class WuIconMoreOutline extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-more-outline')) {
    customElements.define('wu-icon-more-outline',  WuIconMoreOutline);
}
