...
export default class WuIconReceiving extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-receiving')) {
    customElements.define('wu-icon-receiving',  WuIconReceiving);
}
