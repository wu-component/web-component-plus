...
export default class WuIconCoordinate extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-coordinate')) {
    customElements.define('wu-icon-coordinate',  WuIconCoordinate);
}
