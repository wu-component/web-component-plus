...
export default class WuIconSOpportunity extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-s-opportunity')) {
    customElements.define('wu-icon-s-opportunity', WuIconSOpportunity);
}
