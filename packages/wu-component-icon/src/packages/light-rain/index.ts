...
export default class WuIconLightRain extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-light-rain')) {
    customElements.define('wu-icon-light-rain', WuIconLightRain);
}
