...
export default class WuIconLocationInformation extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-location-information')) {
    customElements.define('wu-icon-location-information',  WuIconLocationInformation);
}
