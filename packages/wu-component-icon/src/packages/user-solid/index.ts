...
export default class WuIconUserSolid extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-user-solid')) {
    customElements.define('wu-icon-user-solid',  WuIconUserSolid);
}
