...
export default class WuIconLightning extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-lightning')) {
    customElements.define('wu-icon-lightning',  WuIconLightning);
}
