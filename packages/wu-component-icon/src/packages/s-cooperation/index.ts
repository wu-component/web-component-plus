...
export default class WuIconSCooperation extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-s-cooperation')) {
    customElements.define('wu-icon-s-cooperation',  WuIconSCooperation);
}
