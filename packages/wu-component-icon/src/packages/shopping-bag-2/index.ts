...
export default class WuIconShoppingBag2 extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-shopping-bag-2')) {
    customElements.define('wu-icon-shopping-bag-2',  WuIconShoppingBag2);
}
