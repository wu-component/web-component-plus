...
export default class WuIconVideoCamera extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-video-camera')) {
    customElements.define('wu-icon-video-camera', WuIconVideoCamera);
}
