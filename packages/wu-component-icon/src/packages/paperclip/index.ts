...
export default class WuIconPaperclip extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-paperclip')) {
    customElements.define('wu-icon-paperclip', WuIconPaperclip);
}
