...
export default class WuIconStopwatch extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-stopwatch')) {
    customElements.define('wu-icon-stopwatch',  WuIconStopwatch);
}
