...
export default class WuIconVideoPause extends HTMLElement {
    icon: any;
...
if (!customElements.get('wu-icon-video-pause')) {
    customElements.define('wu-icon-video-pause', WuIconVideoPause);
}
