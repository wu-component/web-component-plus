...
export default class WuIconShoppingCartFull extends HTMLElement {
    icon: any
...
if (!customElements.get('wu-icon-shopping-cart-full')) {
    customElements.define('wu-icon-shopping-cart-full',  WuIconShoppingCartFull);
}
